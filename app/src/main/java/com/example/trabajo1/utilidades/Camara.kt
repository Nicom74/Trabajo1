...
class Camara(
    ...
    fun startFrontCamera(previewUseCase: Preview) {
        bindCamera(
    ...
    fun startSelfiePortraitMode(previewUseCase: Preview) {
    ...
    private fun bindCamera(cameraSelector: CameraSelector, previewUseCase: Preview, useExtensions: Boolean, providerAlreadyFetched: ProcessCameraProvider? = null) {
